...
demo_output = st.Page(
    "demos/001_basic_output.py",
    title="Basic output",
    icon=":material/output:",
    default=True,
)
demo_data = st.Page(
    "demos/002_data_output.py", title="Data output", icon=":material/database:"
)
demo_flow = st.Page(
    "demos/003_flow_control.py", title="Flow control", icon=":material/account_tree:"
)
demo_user_input = st.Page(
    "demos/004_user_input.py", title="User input", icon=":material/input:"
)
demo_layout = st.Page(
    "demos/005_layout.py", title="Layout", icon=":material/dashboard:"
)

exercise1 = st.Page(
    "exercises/001_forms.py", title="Forms", icon=":material/check_box:"
)
exercise2 = st.Page(
    "exercises/002_plotting.py", title="Plotting", icon=":material/pie_chart:"
)
exercise3 = st.Page(
    "exercises/003_genai.py", title="GenAI", icon=":material/network_intelligence:"
)

hackathon = st.Page(
    "hackathon/app.py", title="Hackathon", icon=":material/construction:"
)
